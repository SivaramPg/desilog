...
const FileExtensionSelection = ({
  ...
  return (
    ...
    >
      <button
        className={cn(
          'shadow-sm border border-gray-500 px-3 sm:px-4 lg:px-6 py-2 text-sm sm:text-md md:text-lg lg:text-xl font-semibold rounded-l duration-200',
          extension === 'jpg'
      ...
      <button
        className={cn(
          'shadow-sm border border-gray-500 px-3 sm:px-4 md:px-6 py-2 text-sm sm:text-md md:text-lg lg:text-xl font-semibold rounded-r duration-200',
          extension === 'png'
            ? 'bg-fuchsia-500 border-fuchsia-500 text-white font-black'
            : 'bg-gray-100'
        )}
