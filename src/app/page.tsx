...
export default function Home() {
  return (
    <main className="w-full min-h-screen py-20">
      <h2 className="text-7xl font-black text-center drop-shadow-sm">
      ...
      <section className="container mx-auto grid grid-flow-row-dense grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-8 py-10 px-4">
        {new Array(AVATARS_COUNT - 1).fill(0).map((_, i) => (
          <a
            key={i}
